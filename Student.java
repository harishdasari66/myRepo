...
public class Student 
{
	...
	try
	{
		...
		pst=CommonConnection.connection.prepareStatement("insert into student values(?,?,?,?,?,?);");
		//resultset =pst.executeQuery("select * from student;");
	...
	//education id
		System.out.println("enter eduaction id :");
