...
public class Address
{
	 ...
	 public static void setAddress()
	 {
		...
		PreparedStatement pst=CommonConnection.connection.prepareStatement("insert into address values(?,?,?,?,?,?,?,?);");	
		...
		if(n==0)
		{
			System.out.println( "zero records inserted into students Address Details");
		}
		else
		{
	 ...
	 public static void getAddressDetails()
		{
			try
			{
				...
				Statement st=CommonConnection.connection.createStatement();//prepareStatement("insert into student values(?,?,?,?,?,?);");
