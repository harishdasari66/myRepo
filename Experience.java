...
public static void setExperienceDetails()
{
	...
	try
	{
		   ...
		   PreparedStatement ps=CommonConnection.connection.prepareStatement("insert into experience values(?,?,?,?);");
		   try
		   {
...
public static void getExperienceDetails()
{
	try
	{
		...
		ResultSet resultset =st.executeQuery("select * from experience;");
