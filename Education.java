...
{  
   ...
   public static void setEducationDetails()
   {
	   ...
	   try
	   {
		   ...
		   PreparedStatement ps=CommonConnection.connection.prepareStatement("insert into education values(?,?,?,?,?,?);");
   ...
   public static void getEducationDetails()
	{
		try
		{
			...
			ResultSet resultset =st.executeQuery("select * from education;");
